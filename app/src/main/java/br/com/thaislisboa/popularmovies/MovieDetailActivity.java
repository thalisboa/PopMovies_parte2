    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getBaseContext(), "You are removing your movie in your Favorite List", Toast.LENGTH_LONG)


            } if(
                    mStar.setOnClickListener(false)
                    )

            {

                Toast.makeText(getBaseContext(), "You are adding your movie in your Favorite List", Toast.LENGTH_LONG);
